...
Dự án "Hệ thống Giám sát Cảm biến Mạng Mesh" được xây dựng nhằm cung cấp nền tảng giám sát môi trường toàn diện, giúp quản trị viên theo dõi mạng lưới thiết bị theo thời gian thực. Ứng dụng đa nền tảng kết nối với Gateway qua WebSocket, cho phép hiển thị số liệu, quản lý lịch sử và cập nhật phần mềm thiết bị từ xa (OTA).
...
\begin{itemize}
    ...
    \item \textbf{React Native \& Expo:} Xây dựng giao diện UI đa nền tảng mượt mà.
    \item \textbf{Zustand:} Quản lý State toàn cục, tối ưu re-render khi xử lý dữ liệu Live.
    \item \textbf{Expo FileSystem:} Tạo và chia sẻ báo cáo dữ liệu (CSV) cục bộ.
    \item \textbf{TailwindCSS \& Reanimated:} Thiết kế UI Glassmorphism và Toast mượt mà.
\end{itemize}
\vspace{-0.3cm}
...
\begin{itemize}
    ...
    \setlength{\parskip}{0pt}
    \setlength{\parsep}{0pt}
    \item \textbf{WebSockets:} Truyền phát stream dữ liệu Sensor thời gian thực.
    \item \textbf{HTTP API (REST):} Cơ chế truy vấn (GET) dữ liệu lịch sử từ máy chủ.
    \item \textbf{Nginx Reverse Proxy:} Chạy song song HTTPS và WSS an toàn trên cùng Port 443.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|l|}
        ...
        \hline
        Dashboard & Thống kê & Hiển thị tóm tắt trạng thái mạng Mesh và thông số hệ thống. & H. Xuân Phú \\
        \hline
        Nodes & Quản lý thiết bị & Liệt kê danh sách Node, theo dõi trạng thái Online/Offline. & H. Quang Quân \\
        \hline
        Sensors & Giám sát Live & Biểu đồ và thông số cảm biến môi trường theo thời gian thực. & H. Quang Quân \\
        \hline
        Server & Monitor Backend & Giám sát tài nguyên máy chủ (CPU, RAM) và trạng thái WebSocket. & H. Xuân Phú \\
        \hline
        Gateway & Monitor Gateway & Giám sát tài nguyên phần cứng (CPU, RAM, Pin, Wi-Fi) trạm trung tâm. & H. Quang Quân \\
        \hline
        \multirow{2}{*}{History} & Truy vấn & Lọc dữ liệu theo thời gian, cảm biến và vẽ biểu đồ lịch sử. & H. Xuân Phú \\ \cline{2-4}
        & Xuất CSV & Xử lý dữ liệu và tạo file báo cáo CSV cục bộ. & H. Xuân Phú \\
        \hline
        Settings & Cấu hình & Tùy chỉnh các ngưỡng giới hạn cảnh báo cho cảm biến. & H. Quang Quân \\
        \hline
        About & Thông tin & Hướng dẫn sử dụng chi tiết và thông tin tiến độ dự án. & H. Quang Quân \\
        \hline
        Backend & Hạ tầng & Xây dựng REST API, WebSockets và thiết lập Nginx Reverse Proxy. & H. Xuân Phú \\
        \hline
        Báo cáo & Tài liệu & Soạn thảo báo cáo đồ án và slide thuyết trình tổng kết. & Phú, Quân \\
        \hline
    \end{tabularx}
