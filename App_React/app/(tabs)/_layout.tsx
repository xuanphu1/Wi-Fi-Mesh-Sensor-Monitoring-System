...
import { Home, Cpu, Activity, Settings, History, HardDrive, Server } from 'lucide-react-native';
...
export default function TabsLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="firmware" options={{ title: 'Firmware', tabBarIcon: ({ color }) => <HardDrive size={22} color={color} /> }} />
